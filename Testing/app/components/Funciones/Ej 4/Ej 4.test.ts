 ...
 */
 ...
 const Lista1: string[] = ["rat", "dog", "cat", "parrot", "cat"];
 const Lista2: string[] = ["cat", "lizard", "rat", "cat"];
 
 var Repetidas = Lista1.filter(i => Lista2.indexOf(i) !== -1)
 console.log(Repetidas); 
 
 test('Se repiten', () => {
     expect(Repetidas).toEqual(['rat', 'cat', 'cat']);
     console.log(Repetidas);
 })